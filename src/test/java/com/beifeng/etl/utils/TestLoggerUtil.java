...
public class TestLoggerUtil {
    ...
    public void testLoggerUtil(){
        String log;
        log = "192.168.100.102^A1449411239.595^A192.168.100.120^A/BfImg.gif?c_time=1449411240818&oid=orderid456&u_mid=gerryliu456&pl=java_server&en=e_cr&sdk=jdk&ver=1";
