...
public class InboundCollector implements IOutputCollector {
    ...
    public void collect(Configuration conf, BaseDimension key, BaseStatsValueWritable value,
        ...
        InboundReducerOutputValue inboundReducerOutputValue = (InboundReducerOutputValue) value;
        ...
        pstmt.setInt(++i, statsInboundDimension.getInbound().getId());
        pstmt.setInt(++i, inboundReducerOutputValue.getActiveUsers());
        pstmt.setInt(++i, inboundReducerOutputValue.getSessions());
